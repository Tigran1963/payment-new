(() => {
    ...
    const paymentFast = document.querySelector(".payment-fast");
    ...
    function go_forward() {
        ...
        paymentFast.setAttribute("hidden", "");
        paymentCard.setAttribute("hidden", "");
        paymentBottom.setAttribute("hidden", "");
    }
    function go_back() {
        paymentCard.removeAttribute("hidden");
        paymentFast.removeAttribute("hidden");
